...
public class JiraController {
	...
	@PostMapping("/create")
	public String createMark(@RequestBody List<ObjectWrapper> object) {
	...
	public String file(@PathVariable String issueId, MultipartHttpServletRequest request) throws IOException {
