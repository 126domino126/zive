...
public class JiraClient {
	...
	public String createIssue(String data, List<ObjectWrapper> attachments) {
		Client client = Client.create();
	...
	public String addAttachments(String issueId, MultipartFile multipart) throws IOException {
		...
		System.out.println("delete: " + fileToUpload.delete());
